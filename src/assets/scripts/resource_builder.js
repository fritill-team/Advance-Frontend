...
if (categories) {
  let categoriesResource = new ResourceBuilder(categories, {
    ...
    formTemplate(item = {}, action = '') {
      return `<form action="${action}" method="post">
      <div class="field-wrapper">
        <label class="field-wrapper__label" for="categories-name">Name <abbr>*</abbr></label>
        <div class="field-wrapper__content">
          <input
             class="field"
             type="text"
      ...
      <div class="field-wrapper">
        <label class="field-wrapper__label" for="categories-description">Score <abbr>*</abbr></label>
        <div class="field-wrapper__content">
          <input
            required
            type="number"
...
if (tags) {
  let tagsResource = new ResourceBuilder(tags, {
    ...
    formTemplate(item = {}, action = '') {
      return `<form action="${action}" method="post">
      <div class="field-wrapper">
        <label class="field-wrapper__label" for="tags-name">Name <abbr>*</abbr></label>
        <div class="field-wrapper__content">
          <input
             class="field"
             type="text"
      ...
      <div class="field-wrapper">
        <label class="field-wrapper__label" for="tags-description">Score <abbr>*</abbr></label>
        <div class="field-wrapper__content">
          <input
            required
            type="number"
